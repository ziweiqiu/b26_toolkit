...
class SRSMicrowaveGenerator(Instrument):
    """
    ...
    def __init__(self, name=None, settings=None):
        ...
        super(SRSMicrowaveGenerator, self).__init__(name, settings)
    ...
    def update(self, settings):
        ...
        """
        super(SRSMicrowaveGenerator, self).update(settings)
        # XXXXX MW ISSUE = START
        # ===========================================
    ...
    def read_probes(self, key):
        ...
        assert key in self._PROBES.keys() #sanity check
